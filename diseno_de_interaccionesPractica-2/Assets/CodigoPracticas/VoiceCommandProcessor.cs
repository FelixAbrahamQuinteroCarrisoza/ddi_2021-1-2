...
namespace IBM.Watsson.Examples
{
    public class VoiceCommandProcessor : MonoBehaviour
    {
        ...
        public delegate void OnVoiceCommandReacognized(string command);
        public OnVoiceCommandReacognized onVoiceCommandReacognized;
                    ...
                    foreach (var alt in res.alternatives)
                    {
                     ...
                     foreach(var word in alt.transcript.Split(' '))
                     {
                         if(commands.Contains(word.ToLower()))
                         {
                             ...
                             onVoiceCommandReacognized?.Invoke(word.ToLower());

                             
                             break;
                         }
                     }
                        // if(alt.transcript.ToLower().Contains("saltar")) 
                        // {  
                        // Debug.Log("Saltar...");
                        // }
